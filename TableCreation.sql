    ...
    CONSTRAINT fk_purchitems_ingredient FOREIGN KEY (Ingredient_ID)
    ...
    CONSTRAINT fk_purchases_purchitem FOREIGN KEY (Purc_Item_ID)
    ...
    CONSTRAINT fk_supplier_purchase FOREIGN KEY (Purchase_ID)
    ...
    CONSTRAINT fk_menu_ingredient FOREIGN KEY (Ingredient_ID)
        REFERENCES Ingredient (Ingredient_ID)
    );
    ...
    CONSTRAINT fk_orderitems_menu FOREIGN KEY (Item_ID)
